...
return new class extends Migration
{
    ...
    {
        Schema::create('pajak_masukan_detail', function (Blueprint $table) {
            $table->id();
            $table->string('no_invoice')->nullable();
            $table->string('no_porec')->nullable();
            ...
            $table->string('nama_supplier_sistem')->nullable();
    ...
    {
        Schema::dropIfExists('pajak_masukan_detail');
    }
};
