...
@section('title', 'PNL - Pajak Keluaran (DB) - Reguler')
...
@section('style')
    ...
    <style>
        ...
        .row-checkbox-retur,
        .row-checkbox-nonstandar,
        #select-all-pkp,
        #select-all-pkpnppn,
        #select-all-npkp,
        #select-all-npkpnppn,
        #select-all-retur,
        #select-all-nonstandar {
            width: 14px;
            height: 14px;
            cursor: pointer;
            accent-color: #1572e8;
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><input type="text"
                                                        ...
                                                        placeholder="Customer ID" data-column="3"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-nonstandar"
                                                        placeholder="NIK" data-column="4"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-nonstandar"
                                                        placeholder="Nama Customer" data-column="5"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-nonstandar"
                                                        placeholder="NPWP Customer" data-column="6"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-nonstandar"
                                                        placeholder="No DO" data-column="7"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-nonstandar"
                                                        placeholder="No Invoice" data-column="8"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-nonstandar"
                                                        placeholder="Tgl Faktur Pajak" data-column="9"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-nonstandar"
                                                        placeholder="Total Harga" disabled></th>
                                                <th><input type="text"
                                    ...
                                    <table class="table table-sm table-striped table-bordered table-hover"
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Tgl Faktur" data-column="8"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Total Harga" data-column="9"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Total Disc" data-column="10"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Total DPP" data-column="11"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Total DPP Lain" data-column="12"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Total PPN" data-column="13"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Alamat" data-column="14"></th>
                                                <th><input type="text"
                                                ...
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Nama NPWP" data-column="16"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Alamat NPWP" data-column="17"></th>
                                                <th><input type="text"
                                                ...
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="ID TKU" data-column="26"></th>
                                                <th><input type="text"
                                                        class="form-control form-control-sm column-filter-pembatalan"
                                                        placeholder="Jenis" data-column="27"></th>
                                            </tr>
